...
import { ArogyaLogoLarge } from './ArogyaLogo';
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-black rounded focus:ring-blue-500"
                />
            ...
            <div className="text-center mb-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <p className="text-xs text-blue-600">
                  ABHA ID: Any 14 digits (e.g., 12345678901234)<br/>
                  Password: <code className="bg-blue-100 px-1 rounded">demo1234</code>
                </p>
              </div>
            </div>

    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'fixed top-16 left-0 z-30 w-40 h-[calc(100vh-4rem)] bg-white border-r border-gray-200 shadow-sm transition-transform duration-300',
          ...
          <div className="p-4 border-b border-gray-600">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2 text-sm border border-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 placeholder-gray-500"
                style={{ color: '#111827' }}
              />
            </div>
          </div>

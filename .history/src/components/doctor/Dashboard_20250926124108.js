...
import { ArogyaLogoMedium } from '../ui/ArogyaLogo';
  ...
  const stats = [
    {
      ...
      change: '+12%',
      changeType: 'positive',
      onClick: () => onNavigate && onNavigate('/doctor/patients')
    },
    {
      ...
      change: '+8%',
      changeType: 'positive',
      onClick: () => onNavigate && onNavigate('/doctor/mapping')
    },
    {
      title: 'Active Cases',
    ...
    },
    {
      ...
      change: '+3',
      changeType: 'neutral',
      onClick: () => onNavigate && onNavigate('/doctor/audit')
    },
  ];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              <Card hover onClick={stat.onClick} className="h-full cursor-pointer">
